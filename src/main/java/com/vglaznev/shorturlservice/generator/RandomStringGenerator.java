...
public class RandomStringGenerator {
    ...
    /**
     * Generate a random string of length 8 in base 64 alphabet.
     * Amount of random strings that method can produce is 64^8 (approx. 2e+14).
     * However, method use random function to generate strings, so collisions can occur.
     * (before all 2e+14 random strings are used)
     *
